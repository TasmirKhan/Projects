...
async def upload_kb(file: UploadFile = File(...)) -> JSONResponse:
    ...
    if ext == ".txt":
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail="Missing optional dependency: pypdf. Install with `pip install pypdf`.") from exc
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail="Missing optional dependency: python-docx. Install with `pip install python-docx`.") from exc
